...
function resetPwd(){
    ...
    if(!useCheckPwd(user.newPassword)){
        return errMsg.value = '新密码格式错误'
    }

    
    axios.post('/proxy/api/user/resetpassword', {
    ...
    <div class="auth">
        ...
        <div class="cart-box">
            ...
            <form action="/user/resetpassword" method="post" class="cart-right" enctype="application/x-www-form-urlencoded">
                ...
                <button class="submit" type="button" @click="resetPwd">RE-Password</button>
                <div class="go">
